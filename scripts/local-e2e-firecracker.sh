...
#
# Usage:
#   scripts/local-e2e-firecracker.sh up      # bring everything up, register host, start agent
#   scripts/local-e2e-firecracker.sh down    # stop agent + backend + frontend (keeps Postgres)
