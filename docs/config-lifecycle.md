...
- [vm-provisioning.md](vm-provisioning.md) — Full provisioning pipeline from user click to gateway responding
- [rootfs-design.md](rootfs-design.md) — Persistence model (ephemeral rootfs vs. persistent data volume)
- [configuration.md](configuration.md) — OpenClaw config schema analysis and gaps
- [design-loadconfig-metadata.md](design-loadconfig-metadata.md) — Runtime config loading in metadata mode
